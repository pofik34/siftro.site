            ...
            <div className="sm:col-span-1">
              ...
              <div className="relative rounded-lg shadow-sm">
                ...
                <input
                  ...
                  autoComplete="name"
                  required
                  className="block w-full pl-10 pr-4 py-2.5 text-black placeholder-gray-400 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
            ...
            <div className="sm:col-span-2">
              ...
              <div className="relative rounded-lg shadow-sm">
                ...
                <textarea
                  ...
                  rows={4}
                  required
                  className="block w-full pl-10 pr-4 py-2.5 text-black placeholder-gray-400 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 resize-none"
